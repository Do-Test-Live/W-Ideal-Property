...
if (isset($_POST['insert'])) {
    ...
    $query = "INSERT INTO `tiantu_hall`(`name`, `description`, `area`, `price`, `image`) VALUES ('$name','$description','$area','$price','$image')";
    ...
    if ($insert) {
        echo "<script>
                alert('Data Added.');
                window.location.href='addtiantu.php';
                </script>";
    }
...
<head>
    ...
    <title>Add Tiantu Data - Ideal Property</title>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label>Area</label>
                                <input type="text" class="form-control" name="area" alt="" required>
                            </div>
                            <div class="mb-3">
                                <label>Price</label>
                                <input type="text" class="form-control" name="price" alt="" required>
                            </div>
                            <div class="mb-3">
                                <label>Image</label>
