...
if (isset($_POST['insert'])) {
    ...
    $query = "INSERT INTO `slider`(`name`, `description`, `area`, `price`, `image`, `section_name`) VALUES ('$name','$description','$area','$price','$image','$section_name')";
...
<head>
    ...
    <title>Add Slider - Ideal Property</title>
